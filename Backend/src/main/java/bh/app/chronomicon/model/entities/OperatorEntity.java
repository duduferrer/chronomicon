...
public class OperatorEntity {
    ...
    public OperatorEntity(int id, StaffEntity operator, Duration workload, RosterEntity shift, boolean rm1, boolean rm2, boolean rm3, boolean rt1, boolean rt2, boolean rt3) {
        this.id = id;
